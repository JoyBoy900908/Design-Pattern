...
input_dim = 6
hidden_dim = 80
output_dim = 2 # 這裡改成 2 的話就是 binary classification，改成 7 的話就是 multi-class classification
classes = ['none', 'adapter', 'singleton', 'strategy', 'observer', 'factory', 'decorator']

class BinaryFRGCNModel(nn.Module):
    def __init__(self):
        super(BinaryFRGCNModel, self).__init__()
